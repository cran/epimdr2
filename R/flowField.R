...
#' system. This function was written Michael J Grayling as part of the archived phaseR package and 
#' re-published in the this 'epimdr2' package under original GPL-3 lisence
#'
